...
# We will write a python script that outputs backend/agent/pan_india_gazetteer.py with extensive coverage.
content = '''"""
...
with open(r"c:\Users\Arya\Downloads\Bharat_Explore_SIH_Tourism\backend\agent\pan_india_gazetteer.py", "w", encoding="utf-8") as f:
    f.write(content)
print("pan_india_gazetteer.py written successfully!")
